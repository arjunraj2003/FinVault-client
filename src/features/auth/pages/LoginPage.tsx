  ...
  return (
    <div className="bg-background text-foreground min-h-screen">
      <div className="flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-2/5 relative bg-black">
          ...
          <div className="relative z-10 flex flex-col justify-end p-12">
            ...
            <h2 className="text-3xl font-light text-white mb-3 leading-tight">
              ...
              <br />
              <span className="font-semibold text-primary">for modern business</span>
            </h2>
            ...
            <div className="mt-12 grid grid-cols-3 gap-4">
              <div>
                <div className="text-xl font-semibold text-white">₹25K Cr+</div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden text-center mb-8">
              <div className="inline-block">
                <span className="text-3xl font-light text-foreground tracking-tight">Fin</span>
                <span className="text-3xl font-bold text-foreground tracking-tight">Vault</span>
              </div>
            </div>
            ...
            <div className="bg-card rounded-2xl shadow-xl border border-border p-6 sm:p-8">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-2 bg-card text-muted-foreground">secure access</span>
                </div>
              </div>
